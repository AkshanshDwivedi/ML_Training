import logging
logging.basicConfig(filename="AkshanshError.log", level=logging.DEBUG)
logging.basicConfig(filename="AkshanshError.log", level=logging.INFO)
logging.basicConfig(filename="AkshanshError.log", level=logging.WARNING)
logging.basicConfig(filename="AkshanshError.log", level=logging.ERROR)
class ListFunctions:
